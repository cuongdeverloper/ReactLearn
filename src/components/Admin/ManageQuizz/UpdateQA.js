...
import { GetAllQuestionApi,PostNewQuestionForQuizz,PostNewAnswerForQuizz,ApiGetQuestionFromQuizId,ApiUpdateInsertQuizzWithQA } from '../../../services/ApiServices';
...
const UpdateQA = () => {
  const [isPreviewImg, setIsPreviewImg] = useState(true)
...
let countCorrect = 0;
    ...
    if( _.isEmpty(selectedOption)) {
      ...
      let response = await ApiUpdateInsertQuizzWithQA({
